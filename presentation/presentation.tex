...
\begin{frame}{\secname}
    ...
    \onslide<3->{\begin{center}
        \arrowdown
    \end{center}
    With regard to the observed gap, we decided to merge and wrap the code into a library to
    share it with the community as a small contribution to make experiments easier.}
\end{frame}
